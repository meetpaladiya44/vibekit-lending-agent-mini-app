 ...
 */
export const APP_NAME: string = 'Vibekit-Lending-Agent-Mini-App';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'User will pass a prompt in NLP and it will send a request to vibekit\'s backend and that API will connect to mcp server of lending agent and then user will get the response in the  mini app\'s UI';
